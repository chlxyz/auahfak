...
<script>
    ...
    function loadTableData(searchQuery = '') {
        const url = base_url + `index.php/Viewer/load_data?page=${currentPage}&limit=${rowsPerPage}&search=${encodeURIComponent(searchQuery)}`;
            ...
            .then(data => {
                ...
                document.querySelectorAll('.previewBtn').forEach(button => {
                    button.addEventListener('click', function () {
                        ...
                        fetch('Viewer/generate_pdf_preview', {
                            method: 'POST',
                            headers: {
