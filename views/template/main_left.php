    ...
    <div class="si-inner visible-xs">
      ...
      <ul class="main-menu">
        ...
        if ($this->session->userdata('login_nik')) {
          ...
          // echo anchor('account/back_portal', '<i class="md md-replay"></i> '. lang('menu_back_portal'), '');
          // echo anchor('account/logout', '<i class="md md-exit-to-app"></i> '. lang('menu_logout'), '');
        }
